...
mi_bomb = PhotoImage(file = r"Images\bomb.png").subsample(2,2)
mi_blank  = PhotoImage(file = r"Images\blank.png").subsample(8,8)
mi_flag  = PhotoImage(file = r"Images\flagged.png").subsample(8,8)
mi0 = PhotoImage(file = r"Images\0.png").subsample(8,8)
mi1 = PhotoImage(file = r"Images\1.png").subsample(8,8)
mi2 = PhotoImage(file = r"Images\2.png").subsample(8,8)
mi3 = PhotoImage(file = r"Images\3.png").subsample(8,8)
mi4 = PhotoImage(file = r"Images\4.png").subsample(8,8)
mi5 = PhotoImage(file = r"Images\5.png").subsample(8,8)
mi6 = PhotoImage(file = r"Images\6.png").subsample(8,8)
mi7 = PhotoImage(file = r"Images\7.png").subsample(8,8)
mi8 = PhotoImage(file = r"Images\8.png").subsample(8,8)
